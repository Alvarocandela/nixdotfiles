...
static const char *const autostart[] = {
  "feh", "--bg-fill", "/home/alvaro/.dots/config/wall/dnord4k_dark.png", NULL,
  "xrandr", "--output", "HDMI-1", "--mode", "2560x1080", "--rate", "100", "--right-of", "eDP-1", NULL,
  "xset", "s", "off", NULL,
  "picom", NULL,
	NULL /* terminate */
};
...
static const char *roficmd[]  = { "~/.config/rofi/bin/launcher", NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *powermenu[]  = { "~/.config/rofi/bin/powermenu", NULL };
static const char *filemanager[] = { "st", "-e", "spf", NULL};
static const char *pdfreader[] = { "zathura", NULL};
static const char *webbrowser[] = { "launch-profiled-firefox", NULL};
static const char *whatsapp[] = { "zapzap", NULL};
static const char *music[] = { "spotify", NULL};
static const char *IDE[] = { "emacsclient", "-c", NULL};
